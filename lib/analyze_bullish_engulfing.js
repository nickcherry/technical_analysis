...
module.exports = (sortedCandles, { lookbehindCandles, lookaheadCandles, groupSizeForPctPriceIncreaseProbability, allowedWickToBodyRatio }) => {
  if (!lookbehindCandles === undefined || lookbehindCandles <= 0) throw new Error('lookbehindCandles must be a positive integer');
