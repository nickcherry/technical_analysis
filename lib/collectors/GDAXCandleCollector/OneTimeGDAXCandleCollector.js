...
class OneTimeGDAXCandleCollector extends EventEmitter {
  constructor(config) {
    super();
  ...
  run() {
    return new Promise((resolve, reject) => {
      ...
      reduce(ranges, [], (candles, range, callback) => {
        ...
        this.emit(OneTimeGDAXCandleCollector.events.COLLECT_BATCH_FINISHED, opts);
...
OneTimeGDAXCandleCollector.events = {
  COLLECT_BATCH_FINISHED: 'OneTimeGDAXCandleCollector.COLLECT_BATCH_FINISHED',
