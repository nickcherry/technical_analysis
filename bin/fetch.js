...
const { defaultPriceHistoryStartDate, defaultProduct, priceHistoryDir } = require('../settings');
...
const PRODUCT = argv.product || defaultProduct;
const START_TIME = Object.freeze(moment(argv['start-time'] || defaultPriceHistoryStartDate));
